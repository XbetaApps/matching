...
window.onload = function() {
    ...
    // Gui buttons
    var buttons = [ { x: 30, y: 240, width: 155, height: 50, text: "العب من جديد"},
                    { x: 30, y: 300, width: 155, height: 50, text: "اظهار التبديلات"},
                    { x: 30, y: 360, width: 155, height: 50, text: "😎 تمكين الذكاء الصناعي"}];
    ...
    function render() {
        ...
        drawCenterText(":التجميع", 30, level.y+40, 150);
        ...
        if (gameover) {
            ...
            context.font = "24px Verdana";
            drawCenterText("خسرت!", level.x, level.y + levelheight / 2 + 10, levelwidth);
        }
    }
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#146cc4";
        context.fillRect(0, 0, canvas.width, canvas.height);
        context.fillStyle = "#ed7979";
        context.fillRect(1, 1, canvas.width-2, canvas.height-2);
        
        // Draw header
        context.fillStyle = "#6b1010";
        context.fillRect(0, 0, canvas.width, 65);
        
        // Draw title
        context.fillStyle = "#effaaf";
        context.font = "24px Verdana";
        context.fillText("تطابق المربعات", 15, 40);
        ...
        for (var i=0; i<buttons.length; i++) {
            if (pos.x >= buttons[i].x && pos.x < buttons[i].x+buttons[i].width &&
                ...
                if (i == 0) {
                    ...
                    // Show Moves
                    showmoves = !showmoves;
                    buttons[i].text = (showmoves?"اخفاء":"اظهار") + " التبديلات";
                } else if (i == 2) {
                    // AI Bot
                    aibot = !aibot;
                    buttons[i].text = (aibot?"تعطيل":"تمكين") + " الذكاء الصناعي";
                }
            }
        }
    }
